...
class myService_Stub : public myService {
 public:
  ...
  void game(::google::protobuf::RpcController* controller,
                       const ::example::myRequest* request,
                       ::example::myResponse* response,
                       ::google::protobuf::Closure* done);
 private:
...
// required int32 num1 = 1;
inline bool myResponse::has_num1() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void myResponse::set_has_num1() {
  _has_bits_[0] |= 0x00000001u;
}
inline void myResponse::clear_has_num1() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void myResponse::clear_num1() {
  num1_ = 0;
  clear_has_num1();
}
inline ::google::protobuf::int32 myResponse::num1() const {
  // @@protoc_insertion_point(field_get:example.myResponse.num1)
  return num1_;
}
inline void myResponse::set_num1(::google::protobuf::int32 value) {
  set_has_num1();
  num1_ = value;
  // @@protoc_insertion_point(field_set:example.myResponse.num1)
}

// required int32 num2 = 2;
inline bool myResponse::has_num2() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void myResponse::set_has_num2() {
  _has_bits_[0] |= 0x00000002u;
}
inline void myResponse::clear_has_num2() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void myResponse::clear_num2() {
  num2_ = 0;
  clear_has_num2();
}
inline ::google::protobuf::int32 myResponse::num2() const {
  // @@protoc_insertion_point(field_get:example.myResponse.num2)
  return num2_;
}
inline void myResponse::set_num2(::google::protobuf::int32 value) {
  set_has_num2();
  num2_ = value;
  // @@protoc_insertion_point(field_set:example.myResponse.num2)
}
